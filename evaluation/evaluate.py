...
class Ui_Evaluation(object):
    ...
    def calculateScore(self):
        ...
        objcricket.execute(
            'select Player,Scored,Faced,Fours,Sixes,Bowled,Maiden,Given,Wkts,Catches,Stumping,RO,Matches from Match')
        self.players_list.clear()
        self.points_list.clear()
    ...
    def setupUi(self, Evaluation):
        ...
        spacerItem2 = QtWidgets.QSpacerItem(
            20, 20, QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, Evaluation):
        ...
        self.evl_headingLabel.setText(_translate(
            "Evaluation", "Evaluate the Performance of Your Fantasy Team"))
